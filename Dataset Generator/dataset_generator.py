...
with open(f'.//dataset_configuration_historical.yalm', 'r') as f:
    leak_pipes = yaml.safe_load(f)
...
results_folder = f'{os.getcwd()}\\real_no_dataset_2018\\'
    ...
    def dataset_generator(self):
        ...
        for leak_i in range(0, number_of_leaks):
            ...
            if 'incipient' in leak_type[leak_i]:
                ...
                leak_node[leak_i].required_pressure = required_pressure
        ...
        if results:
            ...
            for leak_i in range(0, number_of_leaks):
                ...
                file_path = f'{leakages_folder}\\Leak_{NODEID}.xlsx'
            ...
            for leak_i in range(0, number_of_leaks):
                if 'leaknode' in str(leak_node[leak_i]):
                    if 'incipient' in leak_type[leak_i]:
                        ...
                        total_leak_demand[node_id] = leak_demand
                    else:
                        node_id = str(leak_node[leak_i])
...
if __name__ == '__main__':
    ...
    L.dataset_generator()
    # results = wntr.sim.WNTRSimulator(L.wn).run_sim()
    # results.node['pressure'].to_csv('pressure_2018_2.csv')
